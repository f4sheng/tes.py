...
def banner():
    os.system("clear")
    autoketik (f"""
{ungu}   ______       ________ {putih}| {Y}»{putih} Creator {R}:{Y} AmmarBN
{ungu}  / ___/ |     / / ____/ {putih}| {Y}»{putih} Githubb {R}:{G} github.com/AmmarrBN
{ungu}  \__ \| | /| / / __/    {putih}| {Y}»{putih} Youtube {R}:{Y} Ammar Executed
{ungu} ___/ /| |/ |/ / /___    {putih}| {Y}»{putih} Instagr {R}:{biru} instagram.com/ammarexecuted
{ungu}/____/ |__/|__/_____/    {putih}| {Y}»{putih}      Made By {biru}Executed Team
""")
